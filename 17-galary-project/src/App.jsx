...
const App = () => {
  ...
  return (
    <div className='bg-black h-screen p-8 overflow-auto text-white'>
      ...
      <div className='flex justify-center gap-6  items-center p-4'>
        <button
          ...
          className='bg-amber-400 cursor-pointer text-sm active:scale-95 text-black rounded px-4 py-2 font-semibold'>
          Prev
        </button>
        <h4>Page {index}</h4>
        <button
